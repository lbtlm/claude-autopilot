...
GLOBAL_CE_PATH="$GLOBAL_RULES_PATH"
...
# 1.3 项目健康度智能评估
echo "🏥 执行项目健康度智能评估..."
if [ -f "$GLOBAL_RULES_PATH/lib/project-health-assessment.sh" ]; then
    source "$GLOBAL_RULES_PATH/lib/project-health-assessment.sh"
...
# 3.3 智能工作流和编排器状态检查
echo "🎼 检查智能工作流和编排器状态..."
COMMANDS_PATH="$GLOBAL_RULES_PATH/share/claude-autopilot/commands"
WORKFLOWS_PATH="$GLOBAL_RULES_PATH/share/claude-autopilot/workflows"
