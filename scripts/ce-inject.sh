...
if is_directory_empty "$PROJECT_PATH"; then
    ...
    # 验证项目类型参数的有效性
    valid_types="gin-microservice gin-vue3 go-desktop go-general vue3-frontend vue2-frontend react-frontend nextjs-frontend nodejs-general python-desktop python-web python-general bash-scripts java-maven java-gradle rust-project php-project"
...
if [ "$IS_NEW_PROJECT" = true ]; then
    ...
    if [ "$PROJECT_TYPE" = "unknown" ]; then
        ...
        echo "    13) bash-scripts       (Bash脚本项目)"
        echo "    14) java-maven         (Java Maven项目)"
        echo "    15) java-gradle        (Java Gradle项目)"
        ...
        case "$choice" in
            ...
            13) PROJECT_TYPE="bash-scripts" ;;
            14) PROJECT_TYPE="java-maven" ;;
            15) PROJECT_TYPE="java-gradle" ;;
            16) PROJECT_TYPE="rust-project" ;;
            17) PROJECT_TYPE="php-project" ;;
            *)
                echo "❌ 无效选择，退出"
                exit 1
                ;;
